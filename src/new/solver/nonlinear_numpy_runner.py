...
class NonlinearNumpyRunner(SimulationRunner, NewtonRaphsonMixin):
    ...
    def _compute_residual(
        ...
        # TODO: vectorized port of legacy calculate_main_equation
    ...
    def _compute_correction(
        ...
        # TODO: vectorized Jacobian build + np.linalg.solve
        # Pure function of its inputs — unit-testable without runner setup
        raise NotImplementedError
