...
flight_condition = FlightCondition(V_inf=57.85, nu=7.44e-6, rho=2.43, aoa=aoa_list_2, ground_effect_check=False)
...
simulation = Simulation(wing_pool=wingpool, damping_factor=0.8, max_iter=1000, max_residual=1e-3, linear_check=False)
