...
if particoes > 1
    for i=1:(particoes-1)
        ...
        num_part = (b(i)/b_total)*N;                                   %Número de paineis em função do comprimento relativo da partição
...
% Encontrar a coluna do perfil em questão
if airfoil_info(i) < 1
    aux = 0;
    cont = 1;
    if particoes == 1
    ...
    % Uma vez achado a coluna, é preciso extraí-la para manipular os dados
